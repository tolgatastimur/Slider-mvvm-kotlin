...
public class ActivityMainBinding extends android.databinding.ViewDataBinding  {
    ...
    // variables
    @Nullable
    private com.tolga.app.slidermvvmkotlin.ui.main.MainActivityViewModel mViewModel;
    // values
    // listeners
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((com.tolga.app.slidermvvmkotlin.ui.main.MainActivityViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.tolga.app.slidermvvmkotlin.ui.main.MainActivityViewModel ViewModel) {
        this.mViewModel = ViewModel;
    }
    @Nullable
    public com.tolga.app.slidermvvmkotlin.ui.main.MainActivityViewModel getViewModel() {
        return mViewModel;
    }
    ...
    public static ActivityMainBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ActivityMainBinding>inflate(inflater, com.tolga.app.slidermvvmkotlin.R.layout.activity_main, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ActivityMainBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(com.tolga.app.slidermvvmkotlin.R.layout.activity_main, null, false), bindingComponent);
    }
    @NonNull
